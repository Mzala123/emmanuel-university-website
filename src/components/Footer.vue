<template>
  ...
  <footer
      class="relative z-10 bg-slate-100 dark:bg-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20 px-3"
  >
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="flex items-center flex-col w-full mb-10">
            ...
            >
              <img
                  src="../assets/EMUNI transparent logo.png"
                  alt="logo"
                  class="max-w-full"
              />
            </a>
            <p class="text-base text-body-color mb-7">
              Preparing leaders for service to God's people
            </p>
            <p
                class="flex items-center text-sm font-medium text-dark"
            >
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="w-full mb-10">
            ...
            <div class="flex items-center mb-6">
              <a
                  href="javascript:void(0)"
                  class="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-primary hover:bg-primary border-stroke dark:border-dark-3 dark:hover:border-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
              >
                <svg
                    width="8"
                    height="16"
            ...
            <p class="text-base text-body-color">
              &copy; 2023 Emuni. All Rights Reserved
            </p>
          </div>
        </div>
      </div>
